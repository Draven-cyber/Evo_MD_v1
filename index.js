...
async function connectToWA() {
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ Evo-MD 💥 connected to WhatsApp');

      const up = `Evo-MD 💥 connected ✅\n\nPREFIX: ${prefix}`;
